...
export default function () { 
    const pageTitle = "Оформление и декор свадеб, юбилеев, конференций в Минск"
    const pageDescription = `
            Фотозона, банкетный зал, выездная регистрация - мы 
            профессионально разработаем концепт оформления вашей свадьбы, 
            дня рождения или корпоратива. 
        `;
    const pageImage = "/assets/images/works/5.jpg";
    return (
    <main>
    <Helmet
