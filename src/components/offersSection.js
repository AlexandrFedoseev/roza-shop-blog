...
export default () => (
    <div>
        <div className={offersSectionStyles.container} style={{marginBottom: '20px'}}>
            ...
            <Offer linkTo={'/services/delievery-flowers-and-bouquets'} image={'/assets/images/delivery.jpg'} title={'Доставка цветов и букетов'} content={'Максимум – 2 часа в черте города, минимум усилий с вашей стороны В “Розе Азора” можно оформить подписку на цветы, и адресат будет получать букеты точно в заявленные даты.'}></Offer>
            ...
            <Offer image={'/assets/images/decoration.jpg'} title={'Декор и упаковка подарков'} content={'Статуэтки, фигурки, рамы, композиции из живых цветов, кухонные и тематические вещицы - утонченные и нежные, для любого адресата.'}></Offer>
            <Offer image={'/assets/images/stable-flowers.jpg'} title={'Стабилизированные цветы'} content={'Цветы, обработанные специальным составом, чтобы сохранять живой вид годами. Цветы и соцветия живут в этом виде от 2-х до 5 лет, деревья и кустарники - от 5 до 10 лет.'}></Offer>
        </div>
    </div>
)
